...
function startSimulation() {
    document.getElementById("content_s").textContent = "";
    ...
    .then(data => {
        ...
        document.getElementById('content_s').innerHTML= data.output;
...
function startRetrieval() {
    document.getElementById("content_r").textContent="";
    ...
    .then(data => {
        ...
        document.getElementById('content_r').innerHTML= data.output;
